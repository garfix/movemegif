...
//
//    $Builder->addFrame()->setPixelsAsIndexedColors($pixelIndexes, $colorTable)->setUseLocalColorTable(false);
//
//    $Builder->output();
//}
//
...
//        ";
//
//    $builder->addFrame(0, 0)->setPixelsAsIndexedColors($frame2, $index2color)->setDuration(50)->setDisposalToOverwriteWithBackgroundColor()
//        ->setUseLocalColorTable(false);
//
